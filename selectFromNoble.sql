...
--You can't put a single quote in a quote string 
--directly. You can use two single quotes within a quoted string.
...
--Alternatively case statement can be use to run the above query
