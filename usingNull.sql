...
--Use COALESCE to print the mobile number. Use the number '07986 444 2266' if there is no number given. Show teacher name 
...
--JOIN to ensure that the Engineering department 
--is listed.
...
--by 'Sci' if the teacher is in dept 1 or 2, show 'Art' if the teacher's dept
